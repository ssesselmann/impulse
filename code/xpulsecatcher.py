...
def pulsecatcher():
	...
	settings = fn.load_settings()	# Load settings
	...
	shape = fn.load_shape(input_path) # Loads shape from file [n,n,n,...]

	#print('shape', shape, device_channels)
	print(audio_format)
	print(device_channels)
	print(input_rate)
	print(input_index)
	print(input_chunk)
